        ...
        viewModelScope.launch {
            try {
                ...
                if (isNewlyCompleted) {
                    ...
                    val updatedQuestCoins = currentQuestCoins.copy(
                        totalEarned = currentQuestCoins.totalEarned + updatedAchievement.boosterBucksReward,
                        currentBalance = currentQuestCoins.currentBalance + updatedAchievement.boosterBucksReward,
                        lastUpdated = Date()
                    )
                    ...
                    addPoints(updatedAchievement.boosterBucksReward)
                }
