...
import java.util.*
import com.opsc6311.poe.data.models.SortOption
...
class TransactionViewModel(
    ...
    fun loadTransactions(accountId: String) {
        viewModelScope.launch {
            ...
            try {
                ...
                val categories = categoriesSnapshot.toObjects(com.opsc6311.poe.data.models.Category::class.java)
    ...
    private fun applyFilterAndSort() {
        ...
        filteredTransactions = when (currentSort) {
            ...
            SortOption.NAME_ASC -> filteredTransactions.sortedBy { it.description ?: "" }
            SortOption.NAME_DESC -> filteredTransactions.sortedByDescending { it.description ?: "" }
        }
